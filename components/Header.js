            ...
            <div className='flex justify-between max-w-6xl mx-5 xl:mx-auto'>
                ...
                <div onClick={() => router.push('/')} className='relative w-24 hidden lg:inline-grid'>
                    <Image
                        ...
                        alt='logo-instragram' objectFit='contain'
                    />
                </div>
                    ...
                    {session ? (
                        <>
                            <div className='relative navBtn'>
                                ...
                                <div className='absoulte -ml-3 -mt-2 text-xs w-5 h-5 bg-red-500 rounded-full flex items-center justify-center animate-pulse text-white'>3</div>
                            </div>
